...
public class QuaterNightVisionItem extends UniversalCurio {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.lovely_sparkle_pieces.quarter_night_vision.des").withColor(ColorUtil.getRainbow()));
        tooltipComponents.add(Component.translatable("tooltip.lovely_sparkle_pieces.quarter_night_vision.des2").withColor(ColorUtil.getRainbow()));
        tooltipComponents.add(Component.translatable("tooltip.lovely_sparkle_pieces.quarter_night_vision.des3").withColor(ColorUtil.getRainbow()));
    }
}
