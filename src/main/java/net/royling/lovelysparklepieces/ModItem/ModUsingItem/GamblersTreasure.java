...
public class GamblersTreasure extends Item {
    private final SoundEvent openSound;

    public static final ResourceKey<LootTable> TREASURE_CHEST_LOOT_TABLE_KEY =
            ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE,
                    ResourceLocation.fromNamespaceAndPath(LovelySparklePieces.MODID, "gameplay/gamblers_treasure"));
    public GamblersTreasure(Properties properties, SoundEvent openSound) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        if (!level.isClientSide()){
            ...
            if(level instanceof ServerLevel serverLevel){
                LootTable lootTable = serverLevel.getServer().reloadableRegistries().getLootTable(TREASURE_CHEST_LOOT_TABLE_KEY);
