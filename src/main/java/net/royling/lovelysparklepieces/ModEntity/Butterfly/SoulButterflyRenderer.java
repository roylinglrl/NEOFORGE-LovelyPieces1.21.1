...
public class SoulButterflyRenderer extends MobRenderer<SoulButterflyEntity, SoulButterflyModel<SoulButterflyEntity>> {
    ...
    public SoulButterflyRenderer(EntityRendererProvider.Context context) {
        super(context,new SoulButterflyModel<>(context.bakeLayer(SoulButterflyModel.LAYER_LOCATION)),0.2F);
    }
    @Override
